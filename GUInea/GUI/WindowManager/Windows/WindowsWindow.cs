    ...
    public class WindowsWindow : Window
    {
        public WindowsWindow()
        {
            WNDCLASS wc = new WNDCLASS
            {
                ...
                lpszClassName = "OpenGL WindowClass"
            };
            ...
            hwnd = CreateWindowEx(
                ...
                WS_OVERLAPPEDWINDOW | WS_VISIBLE | WS_SYSMENU | WS_MINIMIZEBOX | WS_MAXIMIZEBOX | WS_VSCROLL,
                100, 100, 800, 600,
            ...
            _graphicsDevice = new GLGraphicsDevice(this);
        }
